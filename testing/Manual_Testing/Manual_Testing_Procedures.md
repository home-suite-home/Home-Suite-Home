...
**Test Status** *PASS*</br>
#### Test Procedures
1. In the linux command line terminal, from the repo's main directory, ![cd](/artifacts/assets/move_to_testing.PNG) </br> move to the manual testing directory  ![cd](/artifacts/assets/move_to_testing.PNG)
