...
|  3  | Run the *Database_test.py* script | Upon opening the mongoDB GUI (if running on macOS or Windows) you should see an empty databse called *sensorsdb* !(/artifacts/assets/empty_sensorsdb.png) |
